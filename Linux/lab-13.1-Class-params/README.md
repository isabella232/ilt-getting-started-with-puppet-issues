...
1. Run Puppet:
    ...
    2. In the top right corner, click **Run** and select **Puppet**.
    3. Click **Run job**.
    4. You will see that both hosts have made changes. Click their respective **Report** links to view the details.
